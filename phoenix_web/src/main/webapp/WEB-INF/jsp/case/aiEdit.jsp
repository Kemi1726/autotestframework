...
<sf:form method="post" action="editorAi" modelAttribute="caseDTO">
    ...
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td>
                <sf:input path="url" value="${caseExtBean.url}"/><sf:errors path="url"/>
            </td>
        </tr>
        <tr>
            <td class="tableleft">所属项目</td>
            <td>
                <sf:input path="project" value="${caseExtBean.projectId}"/><sf:errors path="project"/>
            </td>
        </tr>
        <tr>
            <td class="tableleft">接口类型</td>
            <td>
                <sf:input path="type" value="${caseExtBean.httpMethod}"/><sf:errors path="type"/>
            </td>
        </tr>
        <tr>
            <td class="tableleft">传参方式</td>
            <td>
                <sf:input path="mode" value="${caseExtBean.contentType}"/><sf:errors path="mode"/>
            </td>
        </tr>
        <tr>
            <td class="tableleft">请求头信息</td>
            <td>
                <sf:input path="header" value="${caseExtBean.header}"/><sf:errors path="header"/>
            </td>
        </tr>

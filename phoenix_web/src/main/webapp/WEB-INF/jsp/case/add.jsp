...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
    	...
    	<td>
    		<sf:select path="caseType" onchange="changeRadio()">
    ...
    <tr id="ext1">
        ...
        <td>
            <sf:input path="url"/><sf:errors path="url"/>
        </td>
    </tr>
    <tr id="ext2">
        <td class="tableleft">所属项目</td>
        <td>
            <sf:input path="project"/><sf:errors path="project"/>
        </td>
    </tr>
    <tr id="ext3">
        <td class="tableleft">接口类型</td>
        <td>
            <sf:input path="type"/><sf:errors path="type"/>
        </td>
    </tr>
    <tr id="ext4">
        <td class="tableleft">传参方式</td>
        <td>
            <sf:input path="mode"/><sf:errors path="mode"/>
        </td>
    </tr>
    <tr id="ext5">
        <td class="tableleft">请求头信息</td>
        <td>
            <sf:input path="header"/><sf:errors path="header"/>
        </td>
    </tr>
    <tr>
...
<script type="text/javascript">
  ...
  function changeRadio(){
      ...
      var val=$('#caseType option:selected').val();
      if(val == 'AI_CASE'){
          $("#ext1").show();
          $("#ext2").show();
          $("#ext3").show();
